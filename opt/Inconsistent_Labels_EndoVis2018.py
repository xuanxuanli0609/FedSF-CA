...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'inc_lab_EndoVis2018' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--client_num_in_total', type=int, default=4, metavar='NN',help='number of workers in a distributed cluster')
        ...
        parser.add_argument('--fineSize', type=int, default=512,help='if_wandb')
        ...
        parser.add_argument('--dataroot',default= '../dataset/Inconsistent_Labels_EndoVis2018',help='path to images')
        ...
        # parser.add_argument('--output_nc',type=int,default= 8, help='output classes')
        parser.add_argument('--output_nc',type=int,default= 9, help='output classes')
        parser.add_argument('--bace_ch',type=int,default= 32, help='')
        ...
        parser.add_argument('--loadSize', type=int, default=512,help='if_wandb')
        ...
        parser.add_argument('--load_pretrain', type=str, default='E:/Federated_Learning_for_Segmentation/2D/dataset/Inconsistent_Labels_EndoVis2018/model_fedddpm_1022_210408/model78_folds0.pkl', help='load the pretrained model from the specified location')
        #discraminator
