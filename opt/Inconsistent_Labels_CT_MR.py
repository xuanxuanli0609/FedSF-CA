...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'inc_lab_CT&MR' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--dataroot',default= '../dataset/Inconsistent_Labels_CHAOS_AMOS22',help='path to images')
