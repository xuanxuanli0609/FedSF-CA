...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot',default= '../FedST_dataset/AAF_Face',help='path to images')
        # parser.add_argument('--dataroot',default= '../FedST_dataset/Face_segment',help='path to images')
