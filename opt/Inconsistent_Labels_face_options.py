...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'inc_lab_face' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--dataroot',default= '../dataset/Inconsistent_Labels_face_segment',help='path to images')
