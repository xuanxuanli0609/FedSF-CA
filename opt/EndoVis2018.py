...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'EndoVis2018' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--dataroot',default= '../dataset/EndoVis2018',help='path to images')
        ...
        parser.add_argument('--output_nc',type=int,default= 11, help='output classes')
        parser.add_argument('--bace_ch',type=int,default= 32, help='')

        #loss
        parser.add_argument('--loss_type', choices=['CrossEntropyLoss', 'BCW', 'Focal', 'back', 'Inconsistent_Labels_loss'], default='Focal', help='loss types')
