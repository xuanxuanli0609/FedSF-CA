...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'MM_WHS' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--dataroot',default= '../FedST_dataset/MM_WHS',help='path to images')
        ...
        parser.add_argument('--output_nc',type=int,default= 7, help='output classes')
