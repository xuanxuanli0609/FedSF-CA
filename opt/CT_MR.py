...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'CT&MR' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--fineSize', type=int, default=256,help='if_wandb')
        ...
        parser.add_argument('--dataroot',default= '../dataset/CHAOS_AMOS22',help='path to images')
        parser.add_argument('--resultroot',default= './ckpt_heart',help='path to ckpt')
        ...
        #loss
        parser.add_argument('--loss_type', choices=['CrossEntropyLoss', 'BCW', 'Focal', 'Inconsistent_Labels_loss'], default='Focal', help='loss types')
        ...
        parser.add_argument('--loadSize', type=int, default=256,help='if_wandb')
