...
class FedAvgTrainer(object):
    ...
    def train_cross_validation(self):
        ...
        if self.opt_train.federated_algorithm == 'fedseg':
            save_path = 'model_feseg'
        ...
        elif self.opt_train.fake_dirname == 'style_transfer_image':
            save_path = 'style_transfer'
        ...
        for fold_idx in range(self.opt_train.folds):
            ...
            for round_idx in range(self.opt_train.comm_round):
                ...
                client_indexes = self.client_sampling(round_idx, self.opt_train.client_num_in_total,
                                                      self.opt_train.client_num_per_round)#获取客户端数量
                ...
                plt.plot(np.linspace(1, len(loss_test), len(loss_test)).astype(int), loss_test)
