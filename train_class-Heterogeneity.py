...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='unet', choices=['bisenetv2','unet', 'fedst_ddpm'], help='chooses which model to use,unet...')
    ...
    parser.add_argument('--federated_algorithm', type=str, default='style_transfer', choices=['local', 'fedavg', 'fedseg', 'fedprox', 'feddyn', 'feddc', 'fedddpm', 'fedst_separate', 'fedst_join','style_transfer'], help='chooses which federated learning algorithm to use')
    ...
    elif op.dataset == 'CT_MR':
        from opt.CT_MR import TrainOptions, TestOptions
    elif op.dataset == 'Inconsistent_CT_MR':
    ...
    opt_train.comm_round = op.comm_round
    opt_train.epochs = op.epochs
    opt_train.mixstyle_layers = op.mixstyle_layers
