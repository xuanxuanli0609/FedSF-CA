...
#E:\Federated_Learning_for_Segmentation\2D\FedST_dataset\2D_MM_WHS\train\real_image
#E:\Federated_Learning_for_Segmentation\2D\dataset\Inconsistent_Labels_CHAOS_AMOS22\train_style
parser.add_argument("--stylePath", default="../dataset/Inconsistent_Labels_CHAOS_AMOS22/train_style/0_1/",#E:\Federated_Learning_for_Segmentation\2D\dataset\Face_segment\lineTran\real_image
# parser.add_argument("--stylePath", default="./data/style_MR/",
                    help='path to wikiArt dataset')#E:\Federated_Learning_for_Segmentation\2D\FedST_dataset\Inconsistent_Labels_face_segment\train\real_image
parser.add_argument("--contentPath", default="../dataset/Inconsistent_Labels_CHAOS_AMOS22/train_style/0_0/",
                    help='path to MSCOCO dataset')
parser.add_argument("--outf", default="./CT&MR/MR/",
...
parser.add_argument("--style_weight", type=float, default=0.02,#0.08,#0.02,
