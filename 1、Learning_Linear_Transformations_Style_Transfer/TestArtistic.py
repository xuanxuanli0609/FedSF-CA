...
if __name__ == '__main__':
    ...
    # parser.add_argument("--matrixPath", default='models/r41_ct2mr.pth',
    parser.add_argument("--matrixPath", default='models/r41.pth',
                        help='pre-trained model path')
    #E:\Federated_Learning_for_Segmentation\2D\dataset\Inconsistent_Labels_CHAOS_AMOS22\train\real_image
    parser.add_argument("--stylePath", default="E:/HJX/Euro/",
                        help='path to style image')
    parser.add_argument("--contentPath", default="E:/HJX/Mini/",
                        help='path to frames')
    parser.add_argument("--outf", default="E:/HJX/Mini-Euro/",
    ...
    for ci,(content,contentName) in enumerate(content_loader):
        ...
        for sj,(style,styleName) in enumerate(style_loader):
            ...
            vutils.save_image(transfer,'%s/%s.png'%(opt.outf,contentName),normalize=True,scale_each=True,nrow=opt.batchSize)
