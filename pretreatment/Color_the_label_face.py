...
mask =  cv2.imread('E:/Federated_Learning_for_Segmentation/2D/dataset/CHAOS_AMOS22/train/real_label/1/s0019_229.png', cv2.IMREAD_GRAYSCALE)
print(mask.shape)
mask[mask==2]=0
# plt.imshow(mask)
# plt.show()
...
# 保存彩色化的图像
cv2.imwrite('Inconsistent_Labels_33_s0019_229_1.png', colored_mask)